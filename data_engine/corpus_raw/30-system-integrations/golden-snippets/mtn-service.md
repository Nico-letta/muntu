# Golden Snippet — `src/providers/mtn.service.ts`

> **Couche:** `30-system-integrations` · **Source:** `afriwallet_codebase/src/providers/mtn.service.ts`

Client MTN MoMo: OAuth, RequestToPay, Transfer, polling status.
