/**
 * Golden Snippet — Pipeline WhatsApp + Ollama (IA message pipeline)
 * Source: ai_message_codebase/src/workers/whatsapp.worker.js
 * Flux: upsert user -> MessageLog -> SystemPrompt tier -> Ollama -> Meta send.
 */
