# Golden Snippet — `src/controllers/whatsapp/whatsapp.controller.js`

> **Couche:** `20-backend-api` · **Source:** `ai_message_codebase/src/controllers/whatsapp/whatsapp.controller.js`

Webhook Meta GET verify + POST enqueue whatsapp-job dans Redis.
